...
class modeltype(Enum):
    ...
    def __init__(self, val, create_model_lambda, perform_grid_search_lambda):
        self.val = val
    ...
    bestdt = 3, lambda training_dataset, features, labels: bestdt.train_model(training_dataset, features, labels), lambda features, labels, validation_features, validation_labels: bestdt.perform_grid_search(features, labels, validation_features, validation_labels)
    ...
    bestmlp = 6, lambda training_dataset, features, labels: bestmlp.train_model(training_dataset, features, labels), lambda features, labels, validation_features, validation_labels: bestmlp.perform_grid_search(features, labels, validation_features, validation_labels)
