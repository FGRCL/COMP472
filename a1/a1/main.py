...
def main(training_dataset, test_dataset, model_enum, output_file):
    ...
    # Output
    write_result_to_file(output_file, predictions, confusion, metrics)


def write_result_to_file(output_file, predictions, confusion, metrics):
...
def generate_metrics(metrics):
    print('', file=output_file)
    print('=================================', file=output_file)
    print('TESTING', file=output_file)
    print('=================================', file=output_file)
    print('', file=output_file)

    metric_type = ["PRECISION", "RECALL", "F-MEASURE", "SUPPORT"]
